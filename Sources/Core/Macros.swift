...
///     #Index(MinIndexKind<Product>(groupBy: [\.category], value: \.price))
///     #Index(MaxIndexKind<Product>(groupBy: [\.category], value: \.price))
///
///     var email: String
///     var category: String
///     var price: Int64
...
///
/// **Parameters**:
/// - type: IndexKind implementation (contains field information and type via generic)
/// - unique: Uniqueness constraint (default: false)
/// - name: Custom index name (default: auto-generated by IndexKind)
///
/// **Standard Index Kinds**:
/// - `ScalarIndexKind<T>(fields:)`: VALUE index for sorting and range queries
/// - `CountIndexKind<T>(groupBy:)`: Count aggregation by grouping fields
/// - `SumIndexKind<T>(groupBy:value:)`: Sum aggregation by grouping fields
/// - `MinIndexKind<T>(groupBy:value:)`: Minimum value tracking by grouping fields
/// - `MaxIndexKind<T>(groupBy:value:)`: Maximum value tracking by grouping fields
/// - `AverageIndexKind<T>(groupBy:value:)`: Average value tracking by grouping fields
/// - `VersionIndexKind<T>(field:strategy:)`: Version tracking index
///
