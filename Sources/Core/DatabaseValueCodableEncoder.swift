...
private enum DatabaseValueEncoding {
    static func encode(_ value: any Encodable) throws -> DatabaseValue {
        ...
        case let scalar as Int8: return .int64(Int64(scalar))
        case let scalar as Int16: return .int64(Int64(scalar))
        case let scalar as Int32: return .int64(Int64(scalar))
        case let scalar as Int64: return .int64(scalar)
        case let scalar as UInt: return .uint64(UInt64(scalar))
        case let scalar as UInt8: return .uint64(UInt64(scalar))
        case let scalar as UInt16: return .uint64(UInt64(scalar))
        case let scalar as UInt32: return .uint64(UInt64(scalar))
        case let scalar as UInt64: return .uint64(scalar)
        case let scalar as Float: return .double(Double(scalar))
        case let scalar as Double: return .double(scalar)
