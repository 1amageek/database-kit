...
/// struct Employee {
///     @OWLProperty("http://example.org/onto#name")
///     var name: String
///
///     @OWLProperty("http://example.org/onto#worksFor", to: \Department.id)
...
/// - `static var ontologyPropertyDescriptors: [OntologyPropertyDescriptor]` — `@OWLProperty` フィールドのメタデータ
