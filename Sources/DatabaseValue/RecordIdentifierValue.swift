/// The canonical logical value of a persisted record identifier.
///
...
public indirect enum RecordIdentifierValue: Sendable, Hashable {
    case bool(Bool)
    case int64(Int64)
    case uint64(UInt64)
    case string(String)
    ...
    case composite([RecordIdentifierValue])
