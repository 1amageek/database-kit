    ...
    func completeManifestRoundTrips() throws {
        ...
        #expect(
            try emptyManifest.fingerprint().bytes == ByteString([
                0x45, 0xf3, 0xcf, 0xb3, 0x57, 0xf2, 0x85, 0xc8,
                0xd8, 0x54, 0x59, 0x7a, 0x1d, 0x23, 0xa2, 0x34,
                0x1d, 0xee, 0x97, 0x57, 0x3b, 0x54, 0x1d, 0x46,
                0xbc, 0x21, 0x1c, 0x40, 0xf3, 0x35, 0x26, 0xeb,
            ])
        )
